...
const CATALOG = [
  // 상의
  { id: "t01", tab: "top", shape: "tee", name: "베이직 코튼 반팔 티셔츠", q: "화이트 반팔 티셔츠", colors: [C("화이트", "#f4f2ee"), C("블랙", "#1d1d1f"), C("멜란지", "#b9b8b5"), C("네이비", "#27314a")], styles: ["casual", "minimal", "normcore", "cleangirl", "amekaji", "cityboy"] },
  ...
  { id: "t03", tab: "top", shape: "shirt", name: "옥스포드 버튼다운 셔츠", q: "옥스포드 셔츠", colors: [C("화이트", "#f5f4f0"), C("스카이블루", "#bcd0e6"), C("핑크", "#efcfd3")], styles: ["preppy", "dandy", "oldmoney", "office", "classic", "geekchic", "cityboy"] },
  ...
  { id: "t08", tab: "top", shape: "hoodie", name: "오버핏 후드 티셔츠", q: "오버핏 후드티", colors: [C("그레이", "#a9a9ab"), C("블랙", "#222224"), C("네이비", "#2b3350"), C("세이지", "#a4b09a")], styles: ["street", "hiphop", "skater", "sporty", "athleisure", "casual"] },
  { id: "t09", tab: "top", shape: "sweat", name: "크루넥 맨투맨", q: "크루넥 맨투맨", colors: [C("멜란지", "#b7b6b3"), C("네이비", "#2a3350"), C("오트밀", "#e3d8c4")], styles: ["casual", "cityboy", "amekaji", "normcore", "sporty", "preppy"] },
  { id: "t10", tab: "top", shape: "crop", name: "슬림 크롭 티셔츠", q: "크롭 티셔츠", colors: [C("화이트", "#f5f3ef"), C("블랙", "#1f1f21"), C("핫핑크", "#e0529a")], styles: ["y2k", "highteen", "athleisure", "barbiecore", "cleangirl"] },
  { id: "t11", tab: "top", shape: "jersey", trim: "#f5f5f5", name: "레트로 축구 저지", q: "레트로 축구 저지", colors: [C("블루", "#2c5aa8"), C("레드", "#b8302f"), C("그린", "#2f6b46")], styles: ["blokecore", "sporty", "street", "retro"] },
  ...
  { id: "t13", tab: "top", shape: "polo", name: "피케 폴로 셔츠", q: "피케 폴로셔츠", colors: [C("화이트", "#f6f5f1"), C("네이비", "#26304a"), C("그린", "#3f6a52")], styles: ["preppy", "tenniscore", "oldmoney", "dandy"] },
  ...
  { id: "t15", tab: "top", shape: "tee", pattern: "stripe", patternColor: "#1f2a4a", name: "보더 스트라이프 티셔츠", q: "스트라이프 보더 티셔츠", colors: [C("네이비 보더", "#f4f2ec"), C("레드 보더", "#f6efe8")], styles: ["marine", "casual", "kitsch", "retro"] },
  ...
  { id: "b02", tab: "bottom", shape: "straight", pattern: "denim", name: "스트레이트 청바지", q: "스트레이트 청바지", colors: [C("인디고", "#34466b"), C("미드블루", "#5877a0"), C("빈티지 워싱", "#8aa0bd")], styles: ["casual", "normcore", "minimal", "amekaji", "vintage", "cleangirl"] },
  ...
  { id: "b05", tab: "bottom", shape: "cargo", name: "나일론 카고 팬츠", q: "나일론 카고 팬츠", colors: [C("카키", "#5f6446"), C("블랙", "#222325"), C("베이지", "#c9b999")], styles: ["gorpcore", "street", "techwear", "military", "hiphop"] },
  { id: "b06", tab: "bottom", shape: "jogger", trim: "#f2f2f2", name: "트랙 조거 팬츠", q: "트랙 조거 팬츠", colors: [C("블랙", "#1f2023"), C("네이비", "#24304f"), C("그린", "#2e5a43")], styles: ["sporty", "athleisure", "blokecore", "street"] },
  ...
  { id: "b14", tab: "bottom", shape: "wide", name: "카펜터 워크 팬츠", q: "카펜터 팬츠", colors: [C("브라운", "#6b4d36"), C("베이지", "#c7b18c"), C("블랙", "#222224")], styles: ["workwear", "amekaji", "cityboy", "vintage"] },
  ...
  { id: "d02", tab: "dress", shape: "long_dress", pattern: "floral", patternColor: "#c9707e", name: "플로럴 퍼프 롱 원피스", q: "플로럴 롱원피스", colors: [C("아이보리", "#f3ede0"), C("스카이", "#d9e4ee"), C("버터", "#f1e5bd")], styles: ["boho", "cottagecore", "morigirl", "lovely", "girlish"] },
  ...
  { id: "o03", tab: "outer", shape: "blazer", name: "오버핏 테일러드 블레이저", q: "오버핏 블레이저", colors: [C("블랙", "#1f1f22"), C("그레이", "#77777a"), C("베이지", "#c6b397"), C("네이비", "#262e46")], styles: ["office", "officesiren", "dandy", "oldmoney", "preppy", "minimal", "classic", "chic"] },
  ...
  { id: "o09", tab: "outer", shape: "jacket", pattern: "denim", name: "워시드 데님 재킷", q: "데님 자켓", colors: [C("미드블루", "#5d7ca5"), C("라이트블루", "#a0b6d0")], styles: ["casual", "amekaji", "vintage", "retro", "y2k", "cityboy"] },
  { id: "o10", tab: "outer", shape: "jacket", name: "초어 워크 재킷", q: "초어 자켓", colors: [C("브라운", "#7a5638"), C("네이비", "#27304a"), C("카키", "#66694b")], styles: ["workwear", "amekaji", "cityboy", "military"] },
  ...
  { id: "s03", tab: "shoes", shape: "loafers", name: "페니 로퍼", q: "페니 로퍼", colors: [C("블랙", "#1c1c1e"), C("브라운", "#5b3a28"), C("버건디", "#5a2027")], styles: ["preppy", "dandy", "oldmoney", "geekchic", "darkacademia", "office", "classic", "poetcore"] },
  ...
  { id: "s05", tab: "shoes", shape: "combat", name: "레이스업 워커 부츠", q: "워커 부츠", colors: [C("블랙", "#1b1b1d"), C("브라운", "#553827")], styles: ["punk", "grunge", "gothic", "military", "techwear", "workwear"] },
  ...
  { id: "g04", tab: "bag", shape: "backpack", name: "데일리 백팩", q: "백팩", colors: [C("블랙", "#1e1e20"), C("네이비", "#26304a"), C("브라운", "#6b4a33")], styles: ["gorpcore", "geekchic", "highteen", "sporty", "preppy", "casual"] },
  ...
  { id: "h04", tab: "hat", shape: "bucket", name: "코튼 버킷햇", q: "버킷햇", colors: [C("블랙", "#1f1f21"), C("베이지", "#cdbc9c"), C("데님", "#6582a8")], styles: ["street", "gorpcore", "y2k", "hiphop", "cityboy"] },
  ...
  // 벨트
  { id: "l01", tab: "belt", shape: "belt", pattern: "woven", name: "위빙 이탈리안 레더 벨트", q: "위빙 레더 벨트", colors: [C("다크브라운", "#3e2a20"), C("블랙", "#1d1d1f")], styles: ["minimal", "cleangirl", "classic", "amekaji", "boho", "morigirl"] },
